...
class TwitterWrapper(object):
    ...
    def __init__(self, logdir,
        ...
        if load_from_history and \
                ...
                os.path.exists(self.friendship_history_logdir) and \
                os.path.exists(self.user_history_logdir):
            ...
            self._user_collections = misc_utils.load_object(
                self.user_history_logdir)

            misc_utils.assert_all_same([
                len(self._tweet_collections),
                len(self._friendship_collections),
                len(self._user_collections)])
    ...
    @property
    def user_history_logdir(self):
        return os.path.join(self._logdir, "user.pkl")
